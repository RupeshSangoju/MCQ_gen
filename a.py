...
#get_ipython().run_line_magic('pip', 'install Groq PyPDF2 python-docx langdetect autopep8==2.0.2 certifi==2023.7.22 charset-normalizer==3.1.0 idna==3.4 pycodestyle==2.10.0 pydub==0.25.1 requests==2.31.0 SpeechRecognition==3.9.0 tomli==2.0.1 urllib3==1.26.14 langdetect streamlit')


# In[3]:


#get_ipython().run_line_magic('pip', 'install moviepy beautifulsoup4 requests')
